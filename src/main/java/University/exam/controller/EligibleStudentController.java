...
public class EligibleStudentController {
    ...
    public String importFile(
        ...
        model.addAttribute("matchedStudents", parsedStudents); // all go as matched — no DB validation
        model.addAttribute("invalidRecords", Collections.emptyList());
        ...
        try {
            ...
            for (Map<String, String> rec : studentRecords) {
                ...
                ExamEligibleStudent es = new ExamEligibleStudent(
                    examId, examType, enrollmentNo,
                    rec.getOrDefault("studentName", "Unknown"),
                    div,
                    formattedRollNo,
    ...
    public ResponseEntity<Map<String, Object>> addStudent(
        ...
        ExamEligibleStudent rec = new ExamEligibleStudent(
            examId, examType, trimmedEnrollment,
            studentName.trim(), division.trim(), formattedRollNo,
