...
public class ExamEligibleStudent {
    ...
    public ExamEligibleStudent(Long examId, String examType, String enrollmentNo,
                                String studentName, String division, String rollNo,
    ...
    public ExamEligibleStudent(Long examId, String examType, String enrollmentNo,
                                String studentName, String division,
                                String importedBy, LocalDateTime importedAt) {
        this.examId = examId;
        this.examType = examType;
        this.enrollmentNo = enrollmentNo;
